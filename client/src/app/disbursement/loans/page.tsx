  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl overflow-hidden">
        {loans.length === 0 ? (
          <div className="p-6 text-center text-gray-500">No loans awaiting disbursement.</div>
        ) : (
          <table className="min-w-full divide-y divide-gray-300">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th scope="col" className="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Principal Amount</th>
              ...
              {loans.map((loan) => (
                <tr key={loan._id}>
                  ...
                  <td className="whitespace-nowrap px-3 py-4 text-sm font-medium">
                    <Link href={`/disbursement/loans/${loan._id}`} className="text-indigo-600 hover:text-indigo-900">
                      Manage &rarr;
                    </Link>
                  </td>
                </tr>
